...
3. Copy-out into `~/.config/opencode` remains **unauthorized** until Phase 2 flips hub language ([skill-source-and-host-overlays](./skill-source-and-host-overlays.md) Related).
