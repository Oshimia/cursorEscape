...
| [Procedure registry normalization](./procedure-registry-normalization.md) | **Phase 0 complete; Phase 1 complete** (dual approval; Full CI passed 2026-09-13) | One semantic registry and deterministic projections; agents, skills, rules/workflows; 7×7 all-host agent parity |
