...
**Last updated:** 2026-09-16 (procedure registry normalization)
...
| [Procedure registry normalization](./procedure-registry-normalization.md) | **Phases 0–4 complete**; Phase 5 in review | One semantic registry and deterministic projections; agents, skills, rules/workflows; 7×7 all-host agent parity |
