...
| [Overlay architecture remediation](./overlay-remediation.md) | **Phase 2 complete** (commit pending Reviewer A; Phase 0-1 committed 2026-08-28) | Fix overlay architecture: overlays carry only host differences (per-entry v2 sourcing, promote-into-twin gate composition, golden-render regression surface, CI drift fixes) |
