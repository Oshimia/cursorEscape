...
**Last updated:** 2026-09-18 (procedure registry normalization)
...
| [Procedure registry normalization](./procedure-registry-normalization.md) | **Complete** — Phases 0–6, program complete 2026-09-18 | One semantic registry and deterministic projections; agents, skills, rules/workflows; 7×7 all-host agent parity |
