...
Host-agnostic **Target** contracts for cursorEscape orchestration. Portable contracts live in this folder. Current Cursor agent files (unchanged bodies) live under [overlays/cursor/agents](../../overlays/cursor/agents/) (**Observed** extract). The 2026-08-17 bannered copy remains under [cursor-global-workflow/agents](../../research/imported/cursor-global-workflow/agents/) (archaeology). These pages use host-agnostic role names, not Cursor Task IDs as the contract identity.
