...
pwsh ./scripts/Sync-HostHarness.ps1 -Target Cline -AllowSkew -Apply   # bring-up/live write (Phase 6 owner authorization per [Apply boundary](../featureArchitecture/procedure-registry.md#phase-6-apply-boundary))
