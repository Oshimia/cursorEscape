...
* [Codex host adapter](./codex-host-adapter.md) — seventh stack: explicit `CODEX_HOME` + skill root; managed `AGENTS.md` block, TOML agents, skill wrappers; Active since 2026-09-08 with C1–C6 attested
