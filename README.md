...
| [`overlays/`](overlays/_index.md) | Host-native overlays — [Cursor](overlays/cursor/_index.md) thin wrappers; [OpenCode](overlays/opencode/_index.md) harness (copy-out authorized) |
...
cursorEscape/
  ...
  overlays/opencode/            # OpenCode harness (copy-out authorized)
