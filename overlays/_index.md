...
This folder holds **host-native** skill, agent, rule, and deep-workflow files recorded from a live stack. It is **not** the portable Target contract tree (gold bases: `skills/`, `agents/`, `rules/` — interim: [docs/skills](../docs/skills/_index.md), [docs/agents](../docs/agents/_index.md)) and **not** the Phase 3 research import ([cursor-global-workflow](../research/imported/cursor-global-workflow/)).
