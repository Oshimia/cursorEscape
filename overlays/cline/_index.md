...
| `data/workflows/plan.md`, `data/workflows/review.md`, `data/workflows/closeout.md` | authored in this overlay (serial-review adaptation) | trio only (host-adapted); `plan.md` carries the `planner` and `plan_reviewer` fresh-task routes |
