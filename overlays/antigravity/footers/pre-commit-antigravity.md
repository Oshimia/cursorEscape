...
Map Fast/Full via `{{COMPANION_ROOT}}/workflow/ci-ladder.md` and project scripts. Never pair Full CI with dual-gate reviewer launch.
...
**Related:** `implementer`, skill `composer`, skill `implementation-review`
