...
description: >-
  ...
  (not under the Antigravity adapter tree). Resolves path via local convention
  or defaults to docs/roadmaps/<feature>.md. Use for large/complex phased work,
  Composer handoffs, or when restructuring an approved plan into per-phase Agent
  context.
---
