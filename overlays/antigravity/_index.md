...
| `config/agents/{planner,plan_reviewer,production_readiness_reviewer,bug_reviewer}.md` | [agents/](./agents/) | Planner + reviewer legs; read-only tools; parallel via `invoke_subagent` |
