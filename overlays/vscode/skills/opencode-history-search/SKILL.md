...
# OpenCode history search (VS Code overlay)
...
| Doc | When |
|-----|------|
| [SKILL.md]({{COMPANION_ROOT}}/skills/opencode-history-search/SKILL.md) | Search strategy, CLI commands, export, SQLite fallback + schema gotchas |
