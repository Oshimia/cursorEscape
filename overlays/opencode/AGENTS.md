...
Architecture background (only when the user asks how layers are authored — not for quoting gates): companion `docs/featureArchitecture/instruction-layering.md`, `clean-context-isolation.md`, `intended-workflow.md` via `external_directory`.
