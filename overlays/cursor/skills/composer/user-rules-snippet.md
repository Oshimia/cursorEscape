...
- Do not implement production code or run reviewer-a/Bugbot for phase work — launch a phase subagent that owns implementation-review (≤4 dual-review iterations per pressure-release block). Build an owner approval preview first when visual sign-off is documented or explicitly requested by the owner.
