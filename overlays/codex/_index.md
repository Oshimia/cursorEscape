...
| --- | --- | --- |
| `codex-home` | `AGENTS.md` managed block composed from canonical rules plus [footers/codex-wiring.md](./footers/codex-wiring.md); guard-only `AGENTS.override.md`; seven `agents/*.toml` agents; stateless `hooks.json` plus [hooks/subagent_reminder.ps1](./hooks/subagent_reminder.ps1) | [agents/](./agents/), [hooks/](./hooks/) |
