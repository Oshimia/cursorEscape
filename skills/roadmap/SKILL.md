...
Do not hard-code any one repo’s folder name as a global requirement. See [discovery.md](../../workflow/discovery.md).
...
| **no** | **May restructure** thin Incremental execution bullets into Agent context headings (schema in [plan-agent-context.md](../../workflow/plan-agent-context.md)) **without adding new scope**. Do not invent new phases, files, or behaviors. |
...
| Agent context — Phase N | Per phase — headings in [plan-agent-context.md](../../workflow/plan-agent-context.md) |
...
**Workflow docs:** [plan-agent-context.md](../../workflow/plan-agent-context.md), [phased-multi-agent.md](../../workflow/phased-multi-agent.md), [discovery.md](../../workflow/discovery.md), [documentation-architecture.md](../../workflow/documentation-architecture.md), [iterative-code-review.md](../../workflow/iterative-code-review.md), [_index.md](../../workflow/_index.md)
